...
//
//     final relatedMusicModel = relatedMusicModelFromJson(jsonString);

import 'dart:convert';

RelatedMusicModel relatedMusicModelFromJson(String str) =>
    RelatedMusicModel.fromJson(json.decode(str));

String relatedMusicModelToJson(RelatedMusicModel data) =>
    json.encode(data.toJson());

class RelatedMusicModel {
  int? status;
  String? message;
  List<Result>? result;
  int? totalRows;
  ...
  factory RelatedMusicModel.fromJson(Map<String, dynamic> json) =>
      RelatedMusicModel(
        status: json["status"],
