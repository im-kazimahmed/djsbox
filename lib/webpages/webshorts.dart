...
class WebShortsState extends State<WebShorts> {
  ...
  final PageController _shortPageController = PageController(initialPage: 0);
  final PageController _profileController = PageController(initialPage: 0);
  final PageController _watchLaterController = PageController(initialPage: 0);
...
/* Simple Short */
  ...
  Widget _buildShortPageView() {
    return Stack(
      children: [
        PageView.builder(
          controller: _shortPageController,
                      ...
                      child: ClipRRect(
                        ...
                        child: VideoScreen(
                          ...
                          videoId: shortProvider.shortVideoList?[index].id
                                  .toString() ??
                              "",
                          videoUrl: shortProvider.shortVideoList?[index].content
                                  .toString() ??
                              "",
                        ),
                      ),
                                ...
                                if (Constant.userID == null) {
                                  ...
                                  moreBottomSheet(
                                    shortProvider
                                            ...
                                            .toString() ??
                                        "",
                                    shortProvider.shortVideoList?[index].title
                                            .toString() ??
                                        "",
    ...
    return Stack(
      children: [
                      ...
                      child: ClipRRect(
                        ...
                        child: VideoScreen(
                          ...
                          thumbnailImg: shortProvider
                                  ...
                                  .toString() ??
                              "",
                          videoId: shortProvider.profileShortList?[index].id
                                  .toString() ??
                              "",
                                ...
                                if (Constant.userID == null) {
                                  ...
                                  moreBottomSheet(
                                    shortProvider.profileShortList?[index]
                                            ...
                                            .toString() ??
                                        "",
                                    shortProvider.profileShortList?[index].title
                                            .toString() ??
                                        "",
                                    shortProvider
        ...
        if ((shortProvider.profileShortList != null &&
            (shortProvider.profileShortList?.length ?? 0) > 1))
          Positioned.fill(
            top: 20,
            bottom: 20,
            left: 20,
...
/* WatchLater Short */
  ...
  Widget _buildWatchLaterShortPageView() {
    return Stack(
      children: [
        PageView.builder(
          controller: _watchLaterController,
                      ...
                      child: ClipRRect(
                        ...
                        child: VideoScreen(
                          ...
                          thumbnailImg: shortProvider
                                  ...
                                  .toString() ??
                              "",
                          videoId: shortProvider.watchlaterShortList?[index].id
                                  .toString() ??
                              "",
                          videoUrl: shortProvider
                            ...
                            InkWell(
                              onTap: () {
                                if (Constant.userID == null) {
                                  ...
                                  moreBottomSheet(
                                    shortProvider.watchlaterShortList?[index]
                                            .portraitImg
                                            .toString() ??
                                        "",
                                    shortProvider
        ...
        if ((shortProvider.watchlaterShortList != null &&
            (shortProvider.watchlaterShortList?.length ?? 0) > 1))
          Positioned.fill(
            top: 20,
            bottom: 20,
            left: 20,
...
/* Up Down Button */
  ...
  void _scrollUp() {
    if (widget.shortType == "profile") {
      if (_profileController.page != null) {
      ...
      if (_watchLaterController.page != null) {
      ...
      if (_shortPageController.page != null) {
